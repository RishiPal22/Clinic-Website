      ...
      {showUnderDevelopment && (
        <div
          style={{
            ...
            left: 0,
            width: "100vw",
            height: "100%", // full height but scrollable
            background: "#f8fafc",
            overflowY: "auto",
            padding: "2rem",
            display: "flex",
        ...
        >
          ...
          >
            ...
            >
              We're working hard to bring this feature to life. Thank you for
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:info@rajclinic.com"
                        className="text-blue-600 hover:text-blue-800"
                      >
                        info@rajclinic.com
                      </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Book a consultation with Dr. Sanjay Pal for personalized
              healthcare. We're here to support your journey toward better
              health and wellness.
            </p>
          </div>
              ...
              <Card className="shadow-xl border-0">
                <CardHeader>
                  ...
                  <p className="text-gray-600">
                    Please fill in your information to schedule an appointment
                  </p>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-center space-x-3 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-red-600 text-sm">
                          Make sure to provide your contact information and
                          select a service.
                        </p>
                      </div>
                    </div>
